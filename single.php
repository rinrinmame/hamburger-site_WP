    ...
    <?php if ($url) : ?>
        <div class="c-background__title-single" style="background-image: url( '<?php echo esc_url($url); ?>' )">
            <div class="c-background__archive-cover u-cover__single">
                <h1 class="c-title__single">タイトル</h1>
            </div>
        </div>
    <?php else : ?>
        <div class="c-background__title-single">
            <div class="c-background__archive-cover u-cover__single" style="background-image: url( '<?php echo get_theme_file_uri() . '/images/noimage.jpg'; ?> ')">
